export const PlayIcons = () => {
  return (
    <svg
      viewBox="0 0 24 24"
      className={
        "fill-foreground-light dark:fill-foreground-dark w-4 h-4 group-hover:fill-accent-light-foreground" +
        " dark:group-hover:fill-accent-dark-foreground transition-colors duration-150 ease-in-out"
      }
    ...
    >
      <path
        ...
        className={
          "stroke-2 stroke-foreground-light dark:stroke-foreground-dark group-hover:stroke-accent-light-foreground" +
          " dark:group-hover:stroke-accent-dark-foreground transition-colors duration-150 ease-in-out"
        }
